...
![AMI 地図メッシュDB vs LLM階層構造図](docs/images/map_db_vs_llm_hierarchy.png)
...
![AMI パラダイムシフト構造図](docs/images/paradigm_shift_architecture.png)
...
---
![AMI サバイバルハック漫画2](docs/images/ami_comic.png)
> **「勝負あり！ローカルAI、階層化でゴール！」**
